...
exports.route = function (req, resp) {
    ...
    console.log("youhou");
  //  console.log(resp);
    var traitement_requete = new constructeur(req, resp); // rq en js toute fonction peu servir de construccteur il suffit juste de l'appeler avec le mot clé new 
    ...
    traitement_requete.envoie(resp);
};
